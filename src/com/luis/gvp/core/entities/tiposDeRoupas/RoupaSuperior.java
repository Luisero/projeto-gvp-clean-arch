...
public class RoupaSuperior extends Item implements ILavavel, IEmprestavel {
	private boolean podeEmprestar= true;
	private LocalDate ultimaLavagem = LocalDate.now();
	public RoupaSuperior(String descricao,Cores cor, Tamanho tamanho, LojaDeOrigem lojaOrigem, EstadoConservacao estado, String caminhoFoto)
	{
